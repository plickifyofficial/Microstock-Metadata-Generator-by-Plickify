          ...
          {item.previewUrl ? (
            ...
            >
              ...
              <img
                src={item.previewUrl}
                alt={item.filename}
                className="h-24 w-24 rounded-xl object-cover ring-1 ring-slate-200 dark:ring-slate-700 cursor-zoom-in hover:ring-brand/60 transition-all"
              />
            </a>
          ) : (
            /* Vector placeholder tile (AI/EPS/PDF) */
            <span className="inline-flex h-24 w-24 shrink-0 items-center justify-center rounded-xl bg-brand/10 text-brand ring-1 ring-brand/20">
